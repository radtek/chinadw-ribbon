...
namespace ARM_User.BusinessLayer.Guides
{
    public class CurrencyECB : DomainObject
    {
        ...
        #endregion Fileds
        //
        public interface ICurrencyECBFinder : ISimpleFinder<CurrencyECB, CurrencyECBList>
        {
            CurrencyECBList FindByCondition(decimal id_guides);
            CurrencyECB FindById(decimal id);
        }
        public CurrencyECB()
        {
        }
