...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
    ...
    public class RepBondChgJournal : ReportToExcel
    {
        #region Fields
        ...
        #region Constructors
        public RepBondChgJournal()
        {
        }
        public RepBondChgJournal(RepForm form, LanguageIds language)
        {
            this.form = form;
            this.language = language;
        }
        public RepBondChgJournal(RepForm form, LanguageIds language, DateTime dateBegin, DateTime dateEnd)
            : this(form, language)
        {            
        ...
        protected virtual string GetXml()
        {
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_Rep_BondChg_Journal";
                ...
                XmlExcelProperty[] plist =
        {
          ...
          new XmlExcelProperty("BONDKND_NAME", XmlExcelProperty.XmlType.xmlString),
