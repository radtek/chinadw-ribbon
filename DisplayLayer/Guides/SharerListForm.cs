...
{
    public partial class SharerListForm : DBListROBaseForm
    {
        public SharerListForm()
        {
            InitializeComponent();
        }
        ...
        private void btnRefresh_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                MainBS.DataSource = MapperRegistry.Instance.GetSharerMapper().FindAll();
            ...
            {
                DBSupport.DBErrorHandler(942, oe.Message + Environment.NewLine + "(occured in DBSupport.SharerListForm)");
            }
            finally
            {
        ...
        private void SharerListForm_Load(object sender, EventArgs e)
        {
            btnRefresh.PerformClick();
        }
        ...
        private void BtnView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            new SharerForm((Sharer)MainBS.Current, EditorState.View).ShowDialog();
            if (!UnitOfWork.Instance.IsTransactionStarted)
                UnitOfWork.Instance.BeginTransaction();
        }
        ...
        {
            if (MainBS.Current == null) return;
            if (MainBS.Current.GetType() == typeof(Sharer))
            {
                var sharer = (Sharer)MainBS.Current;
                btnDel.Enabled = !sharer.IsDelete;
            }
        }
        ...
        private void btnEdit_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            try
            {
                var form = new SharerForm((Sharer)MainBS.Current, EditorState.Edit);
