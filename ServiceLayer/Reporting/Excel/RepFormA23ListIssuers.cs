...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
     ...
     *82.	Форма А-23. Список действующих эмитентов по состоянию на __.__.____ года
     */
    public class RepFormA23ListIssuers : ReportToExcel
    {
        #region Fields
        ...
        #region Constructors
        public RepFormA23ListIssuers()
        {
        }

        public RepFormA23ListIssuers(RepForm form, LanguageIds language)
        {
            this.form = form;
        ...
        public RepFormA23ListIssuers(RepForm form, LanguageIds language, DateTime date)
            : this(form, language)
        {
            this.date = date;
        ...
        public System.Data.DataTable Getcursor1()
        {
            ...
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_REP_FORM_A23_LIST_ISSUERS";
        ...
        protected virtual void CreateReportFromXml()
        {
            ...
            try
            {
                ...
                if (InitApplication.CurrentLangId == LanguageIds.Russian)
                {
                    ...
                    ws.Range["B2"].Value = "Форма А-23. Список действующих эмитентов по состоянию на " + date.ToShortDateString() + " года";
                ...
                {
                    ws.Range["B2"].Font.Bold = true;
                    ws.Range["B2"].Value = "Эмитентердің тізімі толық деректермен " + date.ToShortDateString() + "ж.";
                    ws.Range["B2", "G2"].MergeCells = true;
                    ws.Range["B2"].HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignLeft;
                }
                ...
                for (var i = 0; i < dt1.Rows.Count; i++)
                {
                    ...
                    (rngDataRow.Cells[rowIndex, 9] as Range).Value2 = dt1.Rows[i]["NAMERU_FULL"].ToString();
                    (rngDataRow.Cells[rowIndex, 10] as Range).Value2 = dt1.Rows[i]["ORGAN_O"].ToString();
                    (rngDataRow.Cells[rowIndex, 11] as Range).Value2 = dt1.Rows[i]["HOLDERS_SHARES"].ToString();
                ...
                XmlExcelProperty[] plist =
        {
          ...
          new XmlExcelProperty("ORGAN_O", XmlExcelProperty.XmlType.xmlString),         
          new XmlExcelProperty("HOLDERS_SHARES", XmlExcelProperty.XmlType.xmlString),         
