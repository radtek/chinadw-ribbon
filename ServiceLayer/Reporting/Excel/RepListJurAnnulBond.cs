...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
     ...
     *48.	Форма О-14.  Перечень юридических лиц, аннулировавших выпуски облигаций за период c __.__.____г. по __.__.____г.
     */
    public class RepListJurAnnulBond : ReportToExcel
    {
        #region Fields
        ...
        #region Constructors
        public RepListJurAnnulBond()
        {
        }

        public RepListJurAnnulBond(RepForm form, LanguageIds language)
        {
            this.form = form;
        ...
        public RepListJurAnnulBond(RepForm form, LanguageIds language, DateTime dateBegin, DateTime dateEnd)
            : this(form, language)
        {
        ...
        public System.Data.DataTable Getcursor()
        {
            ...
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_REP_LIST_JUR_ANNUL_BOND";
        ...
        protected virtual void CreateReportFromXml()
        {
            ...
            try
            {
                ...
                if (InitApplication.CurrentLangId == LanguageIds.Russian)
                {
                    ...
                    ws.Range["C2"].Value = "Форма О-14.  Перечень юридических лиц, аннулировавших выпуски облигаций за период c " + dateBegin.ToShortDateString() + " г. по " + dateEnd.ToShortDateString() + " г.";
                ...
                {
                    ws.Range["C2"].Font.Bold = true;
                    ws.Range["C2"].Value = "Облигациялар шығарылымды жойған заңды тулғалар тізімі " + dateBegin.ToShortDateString() + " ж. -" + dateEnd.ToShortDateString() + "ж.";
                    ws.Range["C2", "K2"].MergeCells = true;
                    ws.Range["C2"].HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter;
                }
                ...
                for (var i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    (rngDataRow.Cells[rowIndex, 3] as Range).Value2 = dt.Rows[i]["DATE_ANNUL"].ToString();
                    ...
                    (rngDataRow.Cells[rowIndex, 6] as Range).Value2 = dt.Rows[i]["NAME_BUS_SPEC"].ToString();
                    (rngDataRow.Cells[rowIndex, 7] as Range).Value2 = dt.Rows[i]["NAME_BONDKND"].ToString();
                    ...
                    (rngDataRow.Cells[rowIndex, 10] as Range).Value2 = Convert.ToDecimal(dt.Rows[i]["AMOUNT"]);
                    (rngDataRow.Cells[rowIndex, 11] as Range).Value2 = Convert.ToDecimal(dt.Rows[i]["COUNT"]);
