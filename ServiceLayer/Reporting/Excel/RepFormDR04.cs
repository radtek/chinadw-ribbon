...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
     ...
     * 63.	Форма ДР-04. Сводные сведения по уведомлениям о выпуске и размещении депозитарных расписках, базовым активом которых являются акции за период
     */
    public class RepFormDR04 : ReportToExcel
    {
        #region Fields
        ...
        public RepFormDR04(RepForm form, LanguageIds language)
        {
            this.form = form;
        ...
        public RepFormDR04(RepForm form, LanguageIds language, DateTime dateBegin, DateTime dateEnd)
            : this(form, language)
        {
        ...
        public System.Data.DataTable Getcursor()
        {
            ...
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_REP_FORM_DR04";
        ...
        protected virtual void CreateReportFromXml()
        {
            ...
            try
            {
                ...
                ws.Range["A2"].Value = "Форма ДР-04. Сводные сведения по уведомлениям о выпуске и размещении депозитарных расписках, базовым активом которых являются акции за период c " + dateBegin.ToShortDateString() + " г. по " + dateEnd.ToShortDateString() + " г.";
                ...
                for (var i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    (rngDataRow.Cells[rowIndex, 3] as Range).Value2 = dt.Rows[i]["CNT_CATEGORY"].ToString();
                    (rngDataRow.Cells[rowIndex, 4] as Range).Value2 = dt.Rows[i]["CNT_SHARE_DR"].ToString();
                    (rngDataRow.Cells[rowIndex, 5] as Range).Value2 = dt.Rows[i]["PERCENT"].ToString();
