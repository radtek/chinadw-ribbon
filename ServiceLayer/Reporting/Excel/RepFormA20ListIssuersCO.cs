...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
     ...
     *81.	Форма А-20. Список эмитентов прекративщих деятельность по состоянию на __.__.____ года
     */
    public class RepFormA20ListIssuersCO : ReportToExcel
    {
        #region Fields
        ...
        #region Constructors
        public RepFormA20ListIssuersCO()
        {
        }

        public RepFormA20ListIssuersCO(RepForm form, LanguageIds language)
        {
            this.form = form;
        ...
        public RepFormA20ListIssuersCO(RepForm form, LanguageIds language, DateTime date)
            : this(form, language)
        {
            this.date = date;
        ...
        public System.Data.DataTable Getcursor1()
        {
            ...
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_REP_FORM_A20_LIST_ISSUERS_CO";
        ...
        protected virtual void CreateReportFromXml()
        {
            ...
            try
            {
                ...
                if (InitApplication.CurrentLangId == LanguageIds.Russian)
                {
                    ...
                    ws.Range["B2"].Value = "Форма А-20. Список эмитентов прекративших деятельность по состоянию на " + date.ToShortDateString() + " года";
                ...
                {
                    ws.Range["B2"].Font.Bold = true;
                    ws.Range["B2"].Value = "Қызметін тоқтатқан эмитенттер тізімі " + date.ToShortDateString() + "ж.";
                    ws.Range["B2", "G2"].MergeCells = true;
                    ws.Range["B2"].HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignLeft;
                }
                ...
                for (var i = 0; i < dt1.Rows.Count; i++)
                {
                    ...
                    (rngDataRow.Cells[rowIndex, 2] as Range).Value2 = dt1.Rows[i]["DATE_LIQUIDATION"].ToString();
                    (rngDataRow.Cells[rowIndex, 3] as Range).Value2 = dt1.Rows[i]["NAME_OLF"].ToString();
                    (rngDataRow.Cells[rowIndex, 4] as Range).Value2 = dt1.Rows[i]["BIN"].ToString();
                    ...
                    (rngDataRow.Cells[rowIndex, 8] as Range).Value2 = dt1.Rows[i]["NAMERU_FULL"].ToString();
        ...
        {
          new XmlExcelProperty("DATE_LIQUIDATION", XmlExcelProperty.XmlType.xmlString),      
