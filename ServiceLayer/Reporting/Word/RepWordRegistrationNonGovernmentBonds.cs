...
{
    public class RepWordRegistrationNonGovernmentBonds : GeneralWordReport
    {
        #region Fields
        protected Microsoft.Office.Interop.Excel.Range range2;        
        protected Decimal languageId;
#pragma warning disable CS0108 // 'RepWordRegistrationNonGovernmentBonds.wordparagraph' hides inherited member 'WordReport.wordparagraph'. Use the new keyword if hiding was intended.
#pragma warning disable CS0169 // The field 'RepWordRegistrationNonGovernmentBonds.wordparagraph' is never used
        private Microsoft.Office.Interop.Word.Paragraph wordparagraph;
#pragma warning restore CS0169 // The field 'RepWordRegistrationNonGovernmentBonds.wordparagraph' is never used
#pragma warning restore CS0108 // 'RepWordRegistrationNonGovernmentBonds.wordparagraph' hides inherited member 'WordReport.wordparagraph'. Use the new keyword if hiding was intended.
        public Document wordDoc;
        #endregion
        protected decimal? idBond;
        protected string name, address, bin, nameBondKnd, regNum, regOrgName, bondCount, isin, bondPrice, bondAmount, changeCause, dateStr, fio, position, iscommerce;

        public RepWordRegistrationNonGovernmentBonds(RepForm form, LanguageIds language, decimal? idBond)
            : base(form, language)
        {
            this.form = form;
            this.idBond = idBond;
        ...
        protected virtual string GetData()
        {
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_REP_REG_NONGOVERNMENT_BONDS";
