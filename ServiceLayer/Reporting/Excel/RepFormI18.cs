...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
     ...
     * 72.	Форма И-18.  Перечень юридических лиц, осуществивших государственную регистрацию выпусков исламских ценных бумаг, за период
     */
    public class RepFormI18 : ReportToExcel
    {
        #region Fields
        ...
        public RepFormI18(RepForm form, LanguageIds language)
        {
            this.form = form;
        ...
        public RepFormI18(RepForm form, LanguageIds language, DateTime dateBegin, DateTime dateEnd)
            : this(form, language)
        {
        ...
        public System.Data.DataTable Getcursor()
        {
            ...
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_REP_FORM_I18";
        ...
        protected virtual void CreateReportFromXml()
        {
            ...
            try
            {
                ...
                if (InitApplication.CurrentLangId == LanguageIds.Russian)
                    ws.Range["A2"].Value = "Форма И-18. Перечень юридических лиц, осуществивших государственную регистрацию выпусков исламских ценных бумаг, за период c " + dateBegin.ToShortDateString() + " г. по " + dateEnd.ToShortDateString() + " г.";
                ...
                for (var i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    (rngDataRow.Cells[rowIndex, 12] as Range).Value2 = dt.Rows[i]["IC"].ToString();
                    (rngDataRow.Cells[rowIndex, 13] as Range).Value2 = dt.Rows[i]["NAME_STS"].ToString();
                    ...
                    (rngDataRow.Cells[rowIndex, 18] as Range).Value2 = dt.Rows[i]["NAME_FOUNDER"].ToString();
                    (rngDataRow.Cells[rowIndex, 19] as Range).Value2 = dt.Rows[i]["NAME_HOLDER"].ToString();
                    (rngDataRow.Cells[rowIndex, 20] as Range).Value2 = dt.Rows[i]["ORGAN_CONTROL"].ToString();                     
                    rowIndex++;
                }
