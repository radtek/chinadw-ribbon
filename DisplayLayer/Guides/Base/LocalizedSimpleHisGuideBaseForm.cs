...
{
  public partial class LocalizedSimpleHisGuideBaseForm : GuideBaseForm
  {
    protected GuideHisEditorBase editor;

    public LocalizedSimpleHisGuideBaseForm()
    {
      try
      {
        InitEditor();
    ...
    protected virtual void SetEditorsStatus()
    {
      ...
      panelControl1.Enabled = Editor.StateIs(typeof (GuideHisEditorBase.EditingHisState));
    }
    ...
    public override bool CanClose()
    {
      ...
      {
        if (
          XtraMessageBox.Show("Вы действительно хотите выйти без сохранения?", LangTranslate.UiGetText("Внимание"),
