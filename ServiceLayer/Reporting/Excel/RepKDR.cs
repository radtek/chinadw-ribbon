...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
     ...
     * 4.Сведения о сроках представления эмитентами отчетов об итогах размещения казахстанских депозитарных расписок
     */
    public class RepKDR : ReportToExcel
    {
        #region Fields
        ...
        public RepKDR(RepForm form, LanguageIds language)
        {
            this.form = form;
        ...
        public RepKDR(RepForm form, LanguageIds language, DateTime dateBegin,/* DateTime dateEnd,*/ Decimal idRegion, Decimal cancelConfirmRep)
            : this(form, language)
        {
                ...
                XmlExcelProperty[] plist =
        {
          ...
          new XmlExcelProperty("DATE_CONFIRM_PRV_REP", XmlExcelProperty.XmlType.xmlString),
          new XmlExcelProperty("DATE_REP_TERM_PLA", XmlExcelProperty.XmlType.xmlString),
          new XmlExcelProperty("DATE_REP_PAY", XmlExcelProperty.XmlType.xmlString),
          new XmlExcelProperty("COUNT_KDR", XmlExcelProperty.XmlType.xmlDecimal),
          new XmlExcelProperty("COUNT_PL", XmlExcelProperty.XmlType.xmlDecimal),
          new XmlExcelProperty("VALUE_CAPITAL", XmlExcelProperty.XmlType.xmlDecimal),
          new XmlExcelProperty("NAME_PLACEMENT", XmlExcelProperty.XmlType.xmlString),
