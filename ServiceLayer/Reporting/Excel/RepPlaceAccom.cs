...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
    ...
    /*
     Author: Nurlan Ryskeldi
      11.	Место проведения размещения (на организованном или неорганизованном рынке ценных бумаг) 
     */
    public class RepPlaceAccom : ReportToExcel
    {
        #region Fields
        ...
        protected Decimal idPlaceAccom;

        #region Constructors
        public RepPlaceAccom()
        {
        }

        public RepPlaceAccom(RepForm form, LanguageIds language)
        {
            this.form = form;
        ...
        public RepPlaceAccom(RepForm form, LanguageIds language, DateTime dateBegin, DateTime dateEnd, Decimal idPlaceAccom)
            : this(form, language)
        {
            this.dateBegin = dateBegin;
            this.dateEnd = dateEnd;
            this.idPlaceAccom = idPlaceAccom;
        }
        ...
        protected virtual string GetXml()
        {
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_REP_PLACE_ACCOMMODATION";
                ...
                cmd.Parameters.Add("Kind_CB_", OracleDbType.Int32, ParameterDirection.Input);
                ...
                cmd.Parameters["Kind_CB_"].Value = idPlaceAccom;
                ...
                XmlExcelProperty[] plist =
        {
          ...
          new XmlExcelProperty("PLACE_ACCOMMODATION_CB", XmlExcelProperty.XmlType.xmlString),
          new XmlExcelProperty("PERIOD", XmlExcelProperty.XmlType.xmlString),
          new XmlExcelProperty("FACT_PLACE_ACCOMMODATION_CB", XmlExcelProperty.XmlType.xmlString),
