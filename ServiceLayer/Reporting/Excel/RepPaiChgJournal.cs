...
{
    public class RepPaiChgJournal : ReportToExcel
    {
        /*
        ...
        #region Constructors
        public RepPaiChgJournal()
        {
        }
        public RepPaiChgJournal(RepForm form, LanguageIds language)
        {
            this.form = form;
            this.language = language;
        }
        public RepPaiChgJournal(RepForm form, LanguageIds language, DateTime dateBegin, DateTime dateEnd)
            : this(form, language)
        {            
        ...
        protected virtual string GetXml()
        {
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_Rep_PaiChg_Journal";
                ...
                XmlExcelProperty[] plist =
        {
          ...
          new XmlExcelProperty("NAME_FUND", XmlExcelProperty.XmlType.xmlString),
          new XmlExcelProperty("NAME_FUNDKND", XmlExcelProperty.XmlType.xmlString),
          new XmlExcelProperty("MANAGE_COMPANY", XmlExcelProperty.XmlType.xmlString),
