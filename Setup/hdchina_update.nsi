...
Section "Dummy Section" SecDummy
  ...
  CreateShortCut "$SMPROGRAMS\BSB\GRECB\User\АИП Пользователь.lnk" "$INSTDIR\ARM_User.exe" "" "" 0 SW_SHOWMAXIMIZED 
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\BSB_GRECB" "DisplayName" "АИП Пользователь"
