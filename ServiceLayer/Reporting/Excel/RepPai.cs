...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
     ...
     * 4.	Сведения о сроках представления эмитентами отчетов об итогах размещения паев за период
     */
    public class RepPai : ReportToExcel
    {
        #region Fields
        ...
        public RepPai(RepForm form, LanguageIds language)
        {
            this.form = form;
        ...
        public RepPai(RepForm form, LanguageIds language, DateTime dateBegin, DateTime dateEnd, Decimal idRegion, Decimal cancelConfirmRep)
            : this(form, language)
        {
                ...
                XmlExcelProperty[] plist =
        {
          ...
          new XmlExcelProperty("PIF", XmlExcelProperty.XmlType.xmlString),
          ...
          new XmlExcelProperty("DATESUBM", XmlExcelProperty.XmlType.xmlString),
