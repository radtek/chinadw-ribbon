...
namespace ARM_User.ServiceLayer.Reporting.Excel
{
     ...
     */
    public class RepKDRRepayment : ReportToExcel
    {
        #region Fields
        ...
        #region Constructors
        public RepKDRRepayment()
        {
        }

        public RepKDRRepayment(RepForm form, LanguageIds language)
        {
            this.form = form;
        ...
        public RepKDRRepayment(RepForm form, LanguageIds language, DateTime dateBegin, DateTime dateEnd, Decimal idRegion, Decimal cancelConfirmRep)
            : this(form, language)
        {
        ...
        protected virtual string GetXml()
        {
            using (var cmd = ConnectionHolder.Instance.Connection.CreateCommand())
            {
                ...
                cmd.CommandText = "G_REP_KDR_REPAYMENT";
