...
{
  public partial class SimpleHisGuideTreeBaseForm : GuideBaseForm
  {
    protected GuideHisEditorBase editor;

    public SimpleHisGuideTreeBaseForm()
    {
      try
      {
        InitEditor();
    ...
    protected virtual void SetEditorsStatus()
    {
      ...
      treeMain.Enabled = Editor.StateIs(typeof (GuideHisEditorBase.ViewingHisState));

      EditorUtils.ReadOnlyControls(panelControl1.Controls, null, !Editor.StateIs(typeof(GuideHisEditorBase.EditingHisState)));
    }
    ...
    protected virtual void doSaveToExcel()
    {
      ...
      if (saveFileDialog1.ShowDialog() == DialogResult.OK)
        treeMain.ExportToXls(saveFileDialog1.FileName);
    }

    private void SimpleHisGuideBaseForm_Shown(object sender, EventArgs e)
    {
      //if (gridMainView.VisibleColumns.Count > 0 &&
      //    gridMainView.VisibleColumns[0].SummaryItem.SummaryType == DevExpress.Data.SummaryItemType.None)
      //{
      //  gridMainView.VisibleColumns[0].SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count;
      //}
    }
  }
}