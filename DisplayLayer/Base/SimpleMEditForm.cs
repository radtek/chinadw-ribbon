...
{
  public partial class SimpleMEditForm : DBEditBaseForm
  {
    ...
    protected virtual void SimpleMEditForm_Load_1(object sender, EventArgs e)
    {
      /*if (Site != null) return;
      if (editObject.State == DOState.New)
